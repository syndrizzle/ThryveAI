        ...
        >
            <div className="w-full max-w-xl space-y-8">
                <div className="text-center space-y-6">
                    {user?.user_metadata.avatar_url && (
                        <img
                            ...
                            className="w-24 h-24 rounded-full mx-auto border border-white/10 shadow-xl"
                        />
                    )}
                    <div>
                        <h1 className="text-4xl sm:text-5xl font-heading font-medium text-white">
                            Welcome!
                        </h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    <div className="p-6 rounded-2xl bg-neutral-950/50 backdrop-blur-xl border border-white/10 space-y-4 relative z-50">
                        ...
                        <div className="flex gap-3 relative">
                            <div className="relative">
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-3 rounded-xl bg-neutral-900/50 border border-white/10 hover:bg-neutral-800/50 transition-colors focus:outline-none focus:ring-2 focus:ring-white/20"
                                >
                                    <img 
                                ...
                                {dropdownOpen && (
                                    <motion.div
                                        ...
                                        className="fixed mt-2 w-48 bg-neutral-900/95 backdrop-blur-xl border border-white/10 rounded-xl shadow-xl z-[60]"
                                    >
                                        {[
