    ...
    return (
        ...
        >
          <div className="space-y-4 text-center">
            ...
            <p className="text-neutral-300 text-lg sm:text-xl mx-auto max-w-2xl">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="relative group p-[1px] rounded-xl overflow-hidden animate-border [background:linear-gradient(45deg,transparent,theme(colors.neutral.900)_40%,transparent)_padding-box,conic-gradient(from_var(--border-angle),theme(colors.neutral.600/.3)_20%,theme(colors.white)_40%,theme(colors.neutral.600/.3))_border-box]"
          >
